...
var translations = map[string]map[string]string{
	...
	LocaleES: {
		...
		"directory.subtitle":               "Reportes activos de mascotas perdidas y encontradas en toda la comunidad con atributos indexados por IA.",
		...
		"directory.all_reports":            "Todos los Reportes Activos",
